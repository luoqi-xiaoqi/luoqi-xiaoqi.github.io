...
// 拼音（修复发音：用完整汉字带读，不直接读拼音字母）
const PINYIN_DATA = {
    声母: [
        {pinyin:'b', word:'波', sound:'bō'},
        {pinyin:'p', word:'坡', sound:'pō'},
        {pinyin:'m', word:'摸', sound:'mō'},
        {pinyin:'f', word:'佛', sound:'fō'},
        {pinyin:'d', word:'得', sound:'dē'},
        {pinyin:'t', word:'特', sound:'tē'},
        {pinyin:'n', word:'讷', sound:'nē'},
        {pinyin:'l', word:'勒', sound:'lē'},
        {pinyin:'g', word:'哥', sound:'gē'},
        {pinyin:'k', word:'科', sound:'kē'},
        {pinyin:'h', word:'喝', sound:'hē'},
        {pinyin:'j', word:'鸡', sound:'jī'},
        {pinyin:'q', word:'欺', sound:'qī'},
        {pinyin:'x', word:'希', sound:'xī'},
        {pinyin:'zh', word:'知', sound:'zhī'},
        {pinyin:'ch', word:'吃', sound:'chī'},
        {pinyin:'sh', word:'狮', sound:'shī'},
        {pinyin:'r', word:'日', sound:'rì'},
        {pinyin:'z', word:'资', sound:'zī'},
        {pinyin:'c', word:'刺', sound:'cī'},
        {pinyin:'s', word:'丝', sound:'sī'},
        {pinyin:'y', word:'医', sound:'yī'},
        {pinyin:'w', word:'乌', sound:'wū'},
    ],
    单韵母: [
        {pinyin:'a', word:'啊', sound:'ā'},
        {pinyin:'o', word:'喔', sound:'ō'},
        {pinyin:'e', word:'鹅', sound:'ē'},
        {pinyin:'i', word:'衣', sound:'yī'},
        {pinyin:'u', word:'乌', sound:'wū'},
        {pinyin:'ü', word:'鱼', sound:'yú'},
    ],
    复韵母: [
        {pinyin:'ai', word:'爱', sound:'ài', example:'白 bái', tip:'a+i'},
        {pinyin:'ei', word:'欸', sound:'ēi', example:'飞 fēi', tip:'e+i'},
        {pinyin:'ui', word:'威', sound:'wēi', example:'水 shuǐ', tip:'u+ei'},
        {pinyin:'ao', word:'袄', sound:'ǎo', example:'猫 māo', tip:'a+o'},
        {pinyin:'ou', word:'鸥', sound:'ōu', example:'狗 gǒu', tip:'o+u'},
        {pinyin:'iu', word:'优', sound:'yōu', example:'牛 niú', tip:'i+ou'},
        {pinyin:'ie', word:'耶', sound:'yē', example:'月 yuè', tip:'i+e'},
        {pinyin:'üe', word:'约', sound:'yuē', example:'雪 xuě', tip:'ü+e'},
        {pinyin:'er', word:'耳', sound:'ěr', example:'耳 ěr', tip:'特殊韵母'},
    ],
    鼻韵母: [
        {pinyin:'an', word:'安', sound:'ān', example:'山 shān', tip:'前鼻音'},
        {pinyin:'en', word:'恩', sound:'ēn', example:'门 mén', tip:'前鼻音'},
        {pinyin:'in', word:'音', sound:'yīn', example:'金 jīn', tip:'前鼻音'},
        {pinyin:'un', word:'温', sound:'wēn', example:'春 chūn', tip:'前鼻音'},
        {pinyin:'ün', word:'晕', sound:'yūn', example:'云 yún', tip:'前鼻音'},
        {pinyin:'ang', word:'昂', sound:'áng', example:'羊 yáng', tip:'后鼻音'},
        {pinyin:'eng', word:'亨', sound:'hēng', example:'风 fēng', tip:'后鼻音'},
        {pinyin:'ing', word:'鹰', sound:'yīng', example:'星 xīng', tip:'后鼻音'},
        {pinyin:'ong', word:'翁', sound:'wēng', example:'虫 chóng', tip:'后鼻音'},
    ],
};
